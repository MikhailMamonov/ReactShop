...
namespace ReactShop.Infrastructure.Migrations
{
    ...
    [Migration("20211111095854_cartItemForeignKeysModified")]
    partial class cartItemForeignKeysModified
    {
            ...
            modelBuilder.Entity("ReactShop.Core.Entities.ApplicationUser", b =>
                {
                    b.HasOne("ReactShop.Core.Entities.ShoppingCart", "ShoppingCart")
                        .WithOne("User")
                        .HasForeignKey("ReactShop.Core.Entities.ApplicationUser", "ShoppingCartId");
