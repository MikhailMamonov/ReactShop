...
export const addCategoryThunk = (newCategory) => {
  return (dispatch) => {
    ...
    function success(category) {
      return { type: categoryConstants.ADD_CATEGORY_SUCCESS, category };
    }
...
export const deleteCategoryThunk = (id) => {
  return (dispatch) => {
    ...
    function request(id) {
      return { type: categoryConstants.ADD_CATEGORY_REQUEST, id };
    }
    function success(id) {
      return { type: categoryConstants.ADD_CATEGORY_SUCCESS, id };
    }
    function failure(error) {
      return { type: categoryConstants.ADD_CATEGORY_FAILURE, error };
    }
...
export const editCategoryThunk = (id, item) => {
  return (dispatch) => {
    ...
    function success(id, category) {
      return { type: categoryConstants.EDIT_CATEGORY_SUCCESS, id, category };
    }
    function failure(error) {
      return { type: categoryConstants.EDIT_CATEGORY_FAILURE, error, id };
    }
  };
};
